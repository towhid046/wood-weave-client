      ...
      >
        ...
        <div className="p-4">
          <div className="mb-4 space-y-1">
            <h2 className="text-xl font-semibold mb-2">{subcategory_name}</h2>
            <hr />
            <p className="pt-2">
          ...
          <button
            className={`btn w-full rounded-none ${
              mode
                ? "bg-gray-900 hover:bg-[#AB7442]"
                : "bg-[#AB7442] hover:bg-gray-900"
